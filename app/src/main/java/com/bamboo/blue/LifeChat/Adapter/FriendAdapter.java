package com.bamboo.blue.LifeChat.Adapter;
                ...
                public void onClick(View v) {
                   ...
                   notifyDataSetChanged();
                    ...
                    databaseReference.child(ChatFragment.USER).child(ChatFragment.getUid()).child(FRIEND).
                            child(CHAT).child(friend.id).setValue(friend);
                    databaseReference.child(ChatFragment.USER).child(friend.id).child(FRIEND).
                            child(CHAT).child(ChatFragment.getUid()).setValue(new Friend(ChatFragment.getUid(),name,friend.name));
