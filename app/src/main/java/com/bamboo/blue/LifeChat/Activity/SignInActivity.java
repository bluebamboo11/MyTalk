    ...
    private void signSucces() {
        ...
        databaseReference.setValue(token, new DatabaseReference.CompletionListener() {
            ...
            public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                if (saveLoad.loadString(SaveLoad.NAME_U + uid, "").equals("")) {

                    Intent intent = new Intent(SignInActivity.this, LoginActivity.class);
                    finish();
                    startActivityForResult(intent,REQUEST_ACOUT);
                } else {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        if (task.isSuccessful()) {
                            Toast.makeText(SignInActivity.this,
                                    getString(R.string.gui_mail) + user.getEmail(),
                                    Toast.LENGTH_SHORT).show();
                        } else {
                            Log.e(TAG, "sendEmailVerification", task.getException());
                            Toast.makeText(SignInActivity.this,
                                    getString(R.string.loi_gui_mail),
                                    Toast.LENGTH_SHORT).show();
                        }
                        // [END_EXCLUDE]
                    }
