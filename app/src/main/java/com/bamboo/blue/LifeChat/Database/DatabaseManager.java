...
import com.bamboo.blue.LifeChat.Entity.Email;
...
public class DatabaseManager {
    ...
    public ArrayList<Message> getAllMessages(String tab,String uid ,long offset) {
        ArrayList<Message> messageArrayList = new ArrayList<>();
        Cursor cursor = datasource.rawQuery("SELECT * FROM " +Database.TAB_MESSAGE+tab+uid+" ORDER BY id DESC LIMIT 100 OFFSET "+offset, null);
    ...
    public Long setMessages(Message message, String tab,String uid) {
       ...
       return datasource.insert(Database.TAB_MESSAGE+tab+uid, null, contentValues);
